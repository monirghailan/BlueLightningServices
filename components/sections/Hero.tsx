...
export function Hero() {
  return (
    <section className="hero-section gradient-mesh relative min-h-0 overflow-hidden px-4 sm:px-6">
      <div className="mx-auto grid w-full max-w-6xl flex-1 items-center gap-4 sm:gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-8">
        <motion.div
